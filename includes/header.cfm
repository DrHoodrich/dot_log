...
<!--- TemplateBeginEditable name="websitetitle" --->
<title>Employee Intranet || <cfoutput>#pageTitle#</cfoutput></title>
<!-- TemplateEndEditable -->

<!--- TemplateBeginEditable name="keywords" --->
<meta name="keywords" content="employee intranet State Alaska Department Transportation Public Facilities DOT DOTPF DOT&amp;PF ">
<!--- TemplateEndEditable --->
